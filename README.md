...
- Step 5: Install Active Directory and setup a new domain
- Step 6: Created Organzational Unit (OU) titled "Admins" and another titled "Employees" within Active Directory 
- Step 7: Joined Client-1 to created domain (adjusted DNS Settings)
- Step 8: Setup Remote Desktop for non-admin users on Client-1
- Step 9: Uploaded a script with additional users via Powershell ISE to Client-1
